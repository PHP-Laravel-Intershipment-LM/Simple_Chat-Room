...
var msgerName = get(".msger-name");
var msgerChat = get(".msger-chat");
var msgerAvatar = get(".msger-avatar");
var msgerRoom = get(".msger-room");
var sideLeft = 'left';
var sideRight = 'right';
...
msgerForm.addEventListener("submit", function (event) {
  ...
  var msgRoom = msgerRoom.value;
  var msgText = msgerInput.value;
  var msgAvatar = msgerAvatar.value;
  if (!msgText) return; // Send message to server
...
module.exports = __webpack_require__(/*! C:\Apache24\htdocs\Laravel\Simple_Chat_Room\resources\js\main.js */"./resources/js/main.js");
